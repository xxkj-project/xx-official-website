 ...
 * @LastEditTime: 2020-09-18 16:45:51
 * @Desc: 
-->
<template>
...
export default {
  ...
  mounted() {
    // this.$nextTick(() => {
    //   let newContentEl = document.querySelector(".newsContent");
    //   console.log(newContentEl);
    //   let imgs = newContentEl.getElementsByTagName("img");
    //   console.log(imgs);
  ...
  updated() {
    ...
    // let p = contentEl.getElementsByTagName("p");
    let imgs = contentEl.getElementsByTagName("img");
    console.log(imgs);
    for (let i = 0; i < imgs.length; i++) {
      ...
      imgs[i].style.margin = "0 auto 30px";
    }
  },
  methods: {
    getTestData() {
